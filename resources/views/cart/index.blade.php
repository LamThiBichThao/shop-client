        ...
        <div class="row">
          ...
          <div class="col-lg-8 mb-50">
            ...
            <article class="entry">
              ...
              <div class="entry__header">
                ...
                <ul class="entry__meta">
                  ...
                  <li class="entry__meta-category">
                    <span class="entry__meta-label">loại tin: </span><a href="#">Tin tức</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="entry__body">                  
                <div class="entry__excerpt">
                  <p>Từ bộ đồ vest kiểu Savile Row cho đến sắc xanh neons sáng và các loại vải ren, xu hướng hàng đầu của mùa thu 2019 là một sự pha trộn khá tinh tế nhưng không kém phần mâu thuẫn.</p>
                  <div class="entry__read-more">
                    <a href="blog-single.html" class="entry__read-more-link">XEM TIẾP</a>
                  </div>
                </div>
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry__img-holder">
                <a href="blog-single.html">
                  <img src="img/blog/post_2.jpg" alt="" class="entry__img">
                </a>
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry__img-holder">
                <a href="blog-single.html">
                  <img src="img/blog/post_3.jpg" alt="" class="entry__img">
                </a>
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry__img-holder">
                <a href="blog-single.html">
                  <img src="img/blog/post_4.jpg" alt="" class="entry__img">
                </a>
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry__img-holder">
                <a href="blog-single.html">
                  <img src="img/blog/post_5.jpg" alt="" class="entry__img">
                </a>
              </div>
...
<!--               <div class="widget widget_text">
    ...
    </section> <!-- end blog standard -->@endsection